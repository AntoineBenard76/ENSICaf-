...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 12 Juin 2017 à 22:17
...
(17, 'Jonathan', 'test refresh', '2017-06-12 11:11:00', 'annonce', '', '', '', 1, 5, '14.png', 'Professeur'),
...
(20, 'Antoine', 'setrdtgf', '2017-06-13 19:00:00', 'annonce', '', '', '', 5, 7, '', 'Etudiant');
...
CREATE TABLE `commentaire` (
  ...
  `nomAuteur` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `prenomAuteur` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `attributCom` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `commentaire` (`id`, `commentaire`, `idactu`, `nomAuteur`, `prenomAuteur`, `attributCom`, `avatar`) VALUES
(2, 'test bdd', 20, '', '', '', ''),
(4, 'test\r\n', 20, 'BÃ©nard', 'Antoine', 'Etudiant', ''),
(5, 'coucou', 20, 'BÃ©nard', 'Antoine', 'Etudiant', '17.gif');
